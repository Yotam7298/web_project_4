...
function addPopupClosingListeners(popup) {
  popup.addEventListener("mousedown", checkPopupCloseTrigger);
  document.addEventListener("keydown", checkPopupCloseTrigger);
}

function removePopupClosingListeners(popup) {
  popup.removeEventListener("mousedown", checkPopupCloseTrigger);
  document.removeEventListener("keydown", checkPopupCloseTrigger);
}

function checkPopupCloseTrigger(evt) {
  const openPopup = document.querySelector(".popup_opened");
  if (evt.target == openPopup || evt.key === "Escape") {
...
addCardCloseButton.addEventListener("click", addCardCloseButtonHandler);
